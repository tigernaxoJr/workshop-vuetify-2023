import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.fb95d6d7.js";const h=JSON.parse('{"title":"專案設置","description":"","frontmatter":{},"headers":[],"relativePath":"workshop/vuetify/devconfig.md","filePath":"workshop/vuetify/devconfig.md"}'),p={name:"workshop/vuetify/devconfig.md"},o=l(`<h1 id="專案設置" tabindex="-1">專案設置 <a class="header-anchor" href="#專案設置" aria-label="Permalink to &quot;專案設置&quot;">​</a></h1><p>學習如何設置 vite.config.js、Linting。</p><h2 id="base-url" tabindex="-1">BASE_URL <a class="header-anchor" href="#base-url" aria-label="Permalink to &quot;BASE_URL&quot;">​</a></h2><p>物件最上層(和 <code>plugins</code> 同級)加入屬性 <code>base: &#39;/app/&#39;</code>，注意前後要有斜線。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
