import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.1eafcbb1.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"workshop/deploy/manual.md","filePath":"workshop/deploy/manual.md"}'),p={name:"workshop/deploy/manual.md"},o=l(`<p>主要是設置提供 index.html、反向代理</p><h3 id="提供-index-html" tabindex="-1">提供 index.html <a class="header-anchor" href="#提供-index-html" aria-label="Permalink to &quot;提供 index.html&quot;">​</a></h3><p>當路由符合規則時，依序嘗試回傳設置的內容。</p><h3 id="反向代理" tabindex="-1">反向代理 <a class="header-anchor" href="#反向代理" aria-label="Permalink to &quot;反向代理&quot;">​</a></h3><p><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Reverse_proxy_h2g2bob.svg/800px-Reverse_proxy_h2g2bob.svg.png" alt=""></p><h2 id="iis-部屬" tabindex="-1">IIS 部屬 <a class="header-anchor" href="#iis-部屬" aria-label="Permalink to &quot;IIS 部屬&quot;">​</a></h2><ol start="0"><li>IIS 必須有安裝 <code>URL Rewrite Module</code>、<code>Application Request Routing</code>，反向代理好像要從 server 端手動設置？</li><li>轉為應用程式</li><li>web.config 設定：</li></ol><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;?</span><span style="color:#85E89D;">xml</span><span style="color:#B392F0;"> version</span><span style="color:#E1E4E8;">=</span><span style="color:#9ECBFF;">&quot;1.0&quot;</span><span style="color:#B392F0;"> encoding</span><span style="color:#E1E4E8;">=</span><span style="color:#9ECBFF;">&quot;UTF-8&quot;</span><span style="color:#E1E4E8;">?&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">      &lt;/</span><span style="color:#22863A;">rewrite</span><span style="color:#24292E;">&gt;</span></span>
<span class="line"><span style="color:#24292E;">  &lt;/</span><span style="color:#22863A;">system.webServer</span><span style="color:#24292E;">&gt;</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">configuration</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><h2 id="nginx-部屬" tabindex="-1">Nginx 部屬 <a class="header-anchor" href="#nginx-部屬" aria-label="Permalink to &quot;Nginx 部屬&quot;">​</a></h2><p>重點是 <code>try_files</code>，try_files 只能運行於 server, location</p><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># Typically I use this file as a boilerplate to configure an nginx docker container</span></span>
